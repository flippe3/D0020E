...
class KeyRegHandler:
    ...
    def send_request(self, ip_address, search_value, function=""):
    ...
    def get_public_key(self, id_of_actor, ip_address=None):
        response = self.send_request(ip_address=ip_address, search_value=id_of_actor, function="/getPk")
        return True
    ...
    def get_user_id(self, public_key, ip_address=None):
        ...
        response = self.send_request(ip_address=ip_address, search_value=public_key, function="/getUserId")
        return True

    # gets a response from server saying if public key is related to id
    def verify_public_key(self, public_key, ip_address=None):
        response = self.send_request(ip_address=ip_address, search_value=public_key, function="/verifyPk")
        return True

    # gets a response from server saying if id is related to public key
    def verify_id(self, id_of_actor, ip_address=None):
        response = self.send_request(ip_address=ip_address, search_value=id_of_actor, function="/verifyId")
        return True
