...
--
-- Värd: localhost:3306
-- Tid vid skapande: 16 mars 2021 kl 09:25
-- Serverversion: 10.3.27-MariaDB-0+deb10u1
...
-- Databas: `keyregistry`
--
CREATE DATABASE IF NOT EXISTS `keyregistry` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `keyregistry`;
...
('root', '[{\"db\":\"keyregistry\",\"table\":\"users\"}]');
...
('root', '2021-03-02 17:04:16', '{\"collation_connection\":\"utf8mb4_unicode_ci\",\"lang\":\"sv\"}');
